...
qthelp:
	...
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/sphinx120preview.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/sphinx120preview"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/sphinx120preview"
	@echo "# devhelp"
